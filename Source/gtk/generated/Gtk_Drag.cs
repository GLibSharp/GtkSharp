...
#region Autogenerated code
	public partial class Drag {
		...
		public static void DestSet(Gtk.Widget widget, Gtk.DestDefaults flags, Gtk.TargetEntry[] targets, int n_targets, Gdk.DragAction actions) {
			gtk_drag_dest_set(widget == null ? IntPtr.Zero : widget.Handle, (int) flags, targets, n_targets, (int) actions);
		}
		...
		public static void SourceSet(Gtk.Widget widget, Gdk.ModifierType start_button_mask, Gtk.TargetEntry[] targets, int n_targets, Gdk.DragAction actions) {
			gtk_drag_source_set(widget == null ? IntPtr.Zero : widget.Handle, (int) start_button_mask, targets, n_targets, (int) actions);
		}
