...
guint regresssharp_regress_miscobject_get_parent_instance_offset (void);

guint
regresssharp_regress_miscobject_get_parent_instance_offset (void)
{
	return (guint)G_STRUCT_OFFSET (RegressMiscObject, parent_instance);
}
